...
* create the following environment variable
   APP_NAME    # this variable name should be entered by the user at build time
   ENV        # This varibale name should be entered by the user at build time
   TEAM=Devops
...
* create a user called  "builder" and make him as the default user
